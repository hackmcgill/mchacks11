    ...
    <Container>
      <Content>
        <Text>
          ...
          <p>
            Discord is a voice and text platform that allows people to interact
            in real time through audio and video channels. If you are familiar
            with Slack, then you can think of Discord as a more casual version!
            You can download both the desktop and mobile version of Discord by
            visiting{" "}
            <a
          ...
          <ul>
            ...
            <li>
              The column on the very left-hand side of your Discord app is your
              server list. Any time you add a server, you'll see it pop up as a
              small circular icon in this list
            </li>
            <li>
              <b>Pro Tip: </b>You can rearrange your server list by dragging
              server icons up and down
            </li>
          </ul>
          ...
          <ol>
            ...
            <li>A pop-up will appear; click Skip for now</li>
            <li>
              You will then get a notification, asking you to claim your
              account. Enter your email address and password, then click confirm
            </li>
            <li>
              Another pop-up will appear; if you wish to continue to stick with
              the browser version of discord, click skip
            </li>
            <li>
          ...
          <ol>
            <li>Click register, below login button</li>
            <li>
              Enter email, username, password, date of birth, then click
              continue
            </li>
            <li>
              You should receive a confirmation email within the next few
          ...
          <h2>How do I join the McHacks 11 Discord server?</h2>
          <p>
          ...
          <ul>
            <li>
              ...
              <ul>
                <li>
                  These are channels which are specifically made for talking
                  over text
                </li>
                <li>This creates an organized space for people to discuss</li>
                <li>
                  You can create channels for specific topics and add the
                  necessary members for each of the channels. (i.e you can have
                  one general channel, one front-end channel, one back-end
                  channel etc…)
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                <li>
                  These are where you can talk using your voice and video. You
                  also have the ability to share your screen
                </li>
                <li>
                  There is no join call button but rather you join the channel
                  by clicking on it
                </li>
                <li>
                  People on the server can see you are in a voice channel and
                  can also join
                </li>
              </ul>
            </li>
          ...
          <ul>
            <li>
              In text channels you will have a chat in the middle and you will
              be able to write text in there. The message is sent when you press
              enter
            </li>
            <li>
              If you want to go to a new line in the same message, you have to
            ...
            <li>
              ...
              <ul>
                <li>
                  On the chat bar on the left, there is a + button. You can
                  click on this and you will be able to send files that are on
                  your computer to the chat. Discord accepts file formats
                </li>
              </ul>
            </li>
          </ul>
          ...
          <ul>
            <li>
              First you need to join a voice channel. Voice channels have the
              following logo “
            ...
            <li>
              ...
              <ul>
                <li>
                  You might need to check your computer and audio settings to
                  make sure that you are not muted. You can verify this by
                  checking your voice settings in the settings part of discord
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                <li>
                  Once you join a voice channel, you will in the bottom left
                  corner a “Video” option. If you click on it, it will activate
                  your video
                </li>
                <li>You might need to check your video settings</li>
              </ul>
            </li>
            <li>
              <p>Sharing screen:</p>
              <ul>
                <li>
                  Just next to the video options, you will see a “screen”
                  button. If you click on it, it will share your screen
                </li>
              </ul>
